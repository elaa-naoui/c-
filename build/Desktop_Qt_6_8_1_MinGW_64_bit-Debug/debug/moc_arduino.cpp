...
namespace {
struct qt_meta_tag_ZN7arduinoE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7arduinoE = QtMocHelpers::stringData(
    "arduino",
    "handleSerialData",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN7arduinoE[] = {
...
Q_CONSTINIT const QMetaObject arduino::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7arduinoE.offsetsAndSizes,
    qt_meta_data_ZN7arduinoE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7arduinoE_t,
        // Q_OBJECT / Q_GADGET
...
void arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->handleSerialData(); break;
...
void *arduino::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7arduinoE.stringdata0))
